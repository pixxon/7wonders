...
def get_cards_train():
    return [read_data('./new_dataset', 'train', f'train_{i:04}') for i in range(2000)]

def get_cards_val():
    return [read_data('./new_dataset', 'val', f'val_{i:04}') for i in range(100)]
...
balloon_metadata = MetadataCatalog.get("cards_train")
